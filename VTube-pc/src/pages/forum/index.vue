<template>
  <div class="flex h-full w-full">
    <div
      class="hidden md:flex md:w-72 md:flex-col md:border-r md:border-gray-200"
    >
      <div
        class="flex items-center justify-center h-16 border-b border-gray-200"
      >
        <a class="flex items-center gap-2" href="#">
          <icon-ph:twitter-logo class="text-2xl" />
          <span class="font-bold text-xl">VTubetter</span>
        </a>
      </div>
      <nav class="flex flex-col gap-2 p-4">
        <a
          class="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-200"
          href="#"
        >
          <svg
    ...
    <div class="flex-1 border-x border-gray-200">
      ...
      <div class="flex flex-col gap-4 p-4">
        <div class="flex gap-4">
          ...
          <textarea
            class="flex min-h-[80px] w-full bg-background text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 flex-1 rounded-lg border border-gray-200 p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
    ...
    <div class="hidden md:block md:w-80 md:border-l md:border-gray-200">
